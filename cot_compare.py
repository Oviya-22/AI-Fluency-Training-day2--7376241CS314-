...
QUESTIONS = [
    (
        "A student takes three courses costing Rs. 12,000, Rs. 18,000 "
        "and Rs. 15,000. She gets a 15% scholarship on the total and "
        "pays the rest in 4 equal instalments. How much is each instalment?"
    ),

    (
        "A lab has 18 computers. In the morning each computer is shared "
        "by 2 students, and in the afternoon by 3 students. "
